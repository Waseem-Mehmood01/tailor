...
switch($action){
    case "addCart":
        if(!empty($_POST["quantity"])) {
            $itemArray = array((int)cleanVar($_POST["product_id"])=>array( 'product_id'=>(int)cleanVar($_POST["product_id"]), 'quantity'=>(int)cleanVar($_POST["quantity"]), 'size'=>cleanVar($_POST["size"]), 'color'=>cleanVar($_POST["color"]), 'products_price_id'=>(int)cleanVar($_POST["products_price_id"]) ));           
