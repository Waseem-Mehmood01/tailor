...
.login-box-body, .register-box-body {
	background: #ffffff14;
	box-shadow: 4px 3px 7px 6px dimgrey;
}
...
<body class="login-page">
          ...
          <input type="hidden" id="route" name="route"
				...
				<div class="form-group has-feedback">
					<input type="password" class="form-control" name="password"
						id="password" placeholder="Password" required="required" /> <span
				...
				<div class="row">
					...
					<div class="col-xs-12">
						<input
							style="font-style: italic; font-size: large; font-weight: bold;"
							type="button" name="log_in" id="log_in"
	...
	<!-- /.login-box -->
	<div
		style="max-width: 322px; padding: 6px; position: fixed; bottom: 0px; right: 0px;">
		Developed By:<a href="http://waseem.webberbiz.com/" target="_BLANK">
			Waseem Mehmood</a>
	</div>
