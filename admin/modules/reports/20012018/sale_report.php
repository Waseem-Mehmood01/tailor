...
$sql = "SELECT sd.`item`, sd.`dcs` ,sd.`description`,  si.`reciept_workstation`, si.`reciept_type`,si.`tender`,si.`is_reverse`, si.`created_by`,  
	...
	//echo $total_records;
        foreach ($res1 as $row){ 
            if($row['tender'] == 'gift') { $ded_gift +=$row['total_sale'];  }
...
$total_deductions = $ded_gift+$ded_returns+$ded_reverse;
