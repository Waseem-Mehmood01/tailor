...
$tbl->addCell(strtoupper($row['customer_type']));
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
               ...
               <div class="form-group">
				...
				<div class="col-sm-6">
				  <select class="form-control multiselect" name="customer_type" class="form-control">
					
					<option <?php if('' == @$customer_type) { echo 'SELECTED'; } ?> value="">-All-</option>
					<option <?php if('local' == @$customer_type) { echo 'SELECTED'; } ?> value="local">Local</option>
					<option <?php if('visitor' == @$customer_type) { echo 'SELECTED'; } ?> value="visitor">Visitor</option>	
