...
if(isset($_GET['invoice_id'])){
	...
	$invoice = DB::queryFirstRow("select * from purchase_invoice where purchase_invoice_id='".$invoice_id."'");
...
<td>'.date('d-m-Y H:i A', strtotime($invoice['created_on'])).'</td>
			...
			<td style="width: 50%;">Receipt#: '.$invoice['purchase_invoice_id'].'
			</td>
			</tr>
			...
			<tr>
			<td style="width: 50%;">Supplier: '.$invoice['supplier'].'
			</td>		
...
<tr style="text-align:center;">
			<td colspan="2">PURCHASE INVOICE</td>
			</tr>
<tr style="text-align:center;">
			<td colspan="2">-------------------------</td>
			</tr>
...
<td style="text-align: center;">&nbsp;Desired Qty</td>
...
<td style="text-align: center;">&nbsp;Total</td>
		...
		?>
		<?php 
			$invoice_detail = DB::query("select * from purchase_invoice_detail where purchase_invoice_id = $invoice_id");
...
<BR><BR><BR><BR>
	 <div class="col-md-4 pull-right"> 
		<a class="btn btn-default" href="?route=modules/purchase/view_all_purchase"  /><i class="glyphicon glyphicon-chevron-left"></i>&nbsp;View All</a>
