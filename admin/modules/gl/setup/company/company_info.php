		...
		<table  class="table table-bordered table-striped" >
                <tbody> 
                    ...
                    <tr>         
                        ...
                        <td width="65%">
						  <p>Website Title&nbsp;
						   <a href="#" class="editable" data-url="ajax_helpers/ajax_update_company_data.php" data-name="site_title" data-type="text" data-pk="<?php echo $company['company_id'] ;?>" data-title="Edit Website Title"><?php echo $company['site_title'] ;?></a>
						  </p>
                          <p>Meta Robots&nbsp;
						   <a href="#" class="editable" data-url="ajax_helpers/ajax_update_company_data.php" data-name="meta_robots" data-type="text" data-pk="<?php echo $company['company_id'] ;?>" data-title="Edit meta robots"><?php echo $company['meta_robots'] ;?></a>
						  </p>	
                          <p>Meta Description&nbsp;
						   <a href="#" class="editable" data-url="ajax_helpers/ajax_update_company_data.php"  data-name="site_description" data-type="textarea" data-pk="<?php echo $company['company_id'] ;?>" data-title="Edit Website Description"><?php echo $company['site_description'] ;?></a>
						  </p>	
                          <p>Meta Keywords&nbsp;
						   <a href="#" class="editable" data-url="ajax_helpers/ajax_update_company_data.php" data-name="site_tags" data-type="textarea" data-pk="<?php echo $company['company_id'] ;?>" data-title="Edit Website Meta Tags"><?php echo $company['site_tags'] ;?></a>
						  </p>		
						</td>
                    </tr>
				</tbody>
