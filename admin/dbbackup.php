...
$options = array(
    ...
    'db_uname' => 'admin_wood',  //user
    'db_password' => 'Wood@2019', //pass
    'db_to_backup' => 'admin_wood', //database name
    'db_backup_path' => 'DB_BACKUP', //where to backup
    'db_exclude_tables' => array('product_attributes','') //tables to exclude
);

$result = backup_mysql_database($options);
echo '<pre>';
print_r($result);
echo '</pre>';
