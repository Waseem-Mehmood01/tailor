				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
							...
							<div
								onclick="location.href='?route=modules/orders/view_orders&phoneid=app';"
								class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box">
									<span
										class="info-box-icon <?php if($app_orders>0){ echo 'bg-green'; }else{ echo 'bg-aqua'; } ?>"><i
										class="ion ion-ios-cart-outline"></i></span>
									<div class="info-box-content">
										<span class="info-box-text">App Pending Orders</span> <span
											class="info-box-number"><?php echo $app_orders; ?></span>
									</div>
								</div>
							</div>
						...
						<div class="col-md-12">
							<div class="col-md-7">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" data-toggle="tab"
										href="#pizza_sold" role="tab" aria-selected="true">Pizza Sold</a></li>
									<li class="pull-right">
								...
								<div class="tab-content">
									<div class="tab-pane active in" id="sale_report"
										role="tabpanel">
										<!-- LINE CHART -->
									...
									<div class="tab-pane" id="pizza_sold" role="tabpanel">
										<!-- LINE CHART -->
										<div class="box box-info">
							...
							<div class="col-md-5">
								<h3>Average sales by day</h3>
								<div class="chart">
									<canvas id="avgSaleChart" style="height: 200px; width: 510px;"
										width="510" height="200"></canvas>
								</div>
								<div class="col-md-6">
									<div class="small-box"
