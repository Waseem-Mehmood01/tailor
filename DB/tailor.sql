...
MySQL - 10.4.14-MariaDB : Database - tailor
*********************************************************************
*/
...
CREATE TABLE `blocked_ips` (
  `blocked_ips_id` int(11) NOT NULL AUTO_INCREMENT,
  `blocked_ips` varchar(50) NOT NULL,
  PRIMARY KEY (`blocked_ips_id`)
...
CREATE TABLE `categories` (
  ...
  `featured_img` longblob DEFAULT NULL,
...
insert  into `categories`(`categories_id`,`parent_id`,`featured_img`,`name`,`description`,`meta_title`,`meta_description`,`meta_keywords`,`active`) values (216,0,NULL,'Women',NULL,'','','',1);
...
CREATE TABLE `coupons` (
  ...
  `min_shoping` decimal(10,2) DEFAULT 0.00,
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
...
insert  into `coupons`(`coupons_id`,`code`,`discount`,`min_shoping`,`created_on`,`expired_on`,`active`) values (1,'WAS2021','20','10.00','2019-12-04 06:53:23','2019-12-31 20:53:12',1);
...
CREATE TABLE `customers` (
  ...
  `card_no` varchar(150) DEFAULT NULL,
  `card_expiry` varchar(11) DEFAULT NULL,
  `card_csv` int(5) DEFAULT NULL,
...
CREATE TABLE `discounts` (
  ...
  `was_price` double(10,2) DEFAULT 0.00,
  `new_price` double(10,2) NOT NULL DEFAULT 0.00,
  `size` varchar(100) DEFAULT NULL,
  `min_order_qty` int(4) NOT NULL DEFAULT 1,
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
...
/*Table structure for table `items_barcodes` */

DROP TABLE IF EXISTS `items_barcodes`;

CREATE TABLE `items_barcodes` (
  `items_barcodes_id` int(11) NOT NULL AUTO_INCREMENT,
  `item_no` int(11) NOT NULL,
  `vendors_id` int(11) DEFAULT NULL,
  `barcode` varchar(255) NOT NULL,
  `barcode_type` varchar(255) DEFAULT NULL,
  `is_casing` tinyint(1) DEFAULT 0,
  `casing_of` int(3) DEFAULT 1,
  `created_by` varchar(100) DEFAULT NULL,
  `created_on` datetime DEFAULT NULL,
  `modified_on` datetime DEFAULT NULL,
  `modified_by` varchar(100) DEFAULT NULL,
  `active` tinyint(1) DEFAULT 1,
  PRIMARY KEY (`items_barcodes_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `items_barcodes` */
...
CREATE TABLE `orders` (
  ...
  `tax_amount` double(11,2) NOT NULL,
  `order_total` double(11,2) NOT NULL,
  `order_type` varchar(25) DEFAULT 'delivery',
  `pickup_time` datetime DEFAULT NULL,
  `tender` varchar(100) DEFAULT 'COD',
  `transaction_id` varchar(100) DEFAULT NULL,
  `tip` decimal(11,2) DEFAULT 0.00,
  `discount` double(10,2) DEFAULT 0.00,
  `tender_amount` double(10,2) DEFAULT NULL,
...
CREATE TABLE `orders_products` (
  ...
  `products_price_id` int(11) DEFAULT NULL,
...
CREATE TABLE `product_attributes` (
  `p_attributes_id` int(11) NOT NULL AUTO_INCREMENT,
  `p_attributes_name` varchar(512) NOT NULL,
  `p_attributes_value` varchar(512) NOT NULL,
  `product_id` int(11) NOT NULL,
  PRIMARY KEY (`p_attributes_id`)
...
CREATE TABLE `product_reviews` (
  ...
  `reviews_description` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
...
insert  into `products`(`products_id`,`categories_id`,`manufacturers_id`,`sku`,`name`,`description1`,`description2`,`highlights`,`size`,`height`,`joint`,`created_on`,`active`,`meta_title`,`meta_description`,`meta_keywords`,`is_promotion`) values (1522,216,0,'','Flutter Sleeve Zip Back Top & Buttoned High Waist Pants Set','','','',NULL,'','','2021-05-10 14:29:01',1,NULL,NULL,NULL,0);
...
CREATE TABLE `products_img` (
  `products_img_id` int(11) NOT NULL AUTO_INCREMENT,
  `products_id` int(11) NOT NULL,
  `is_360` tinyint(1) DEFAULT NULL,
  `color` varchar(300) DEFAULT NULL,
  `img_path` blob DEFAULT NULL,
  `active` tinyint(1) DEFAULT NULL,
  `order_img` int(11) NOT NULL,
  PRIMARY KEY (`products_img_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3853 DEFAULT CHARSET=latin1;

/*Data for the table `products_img` */

insert  into `products_img`(`products_img_id`,`products_id`,`is_360`,`color`,`img_path`,`active`,`order_img`) values (3851,1522,0,'Black','Wome3851.jpg',1,1),(3852,1522,0,'Red','Wome3852.jpg',1,1);
...
CREATE TABLE `products_price` (
  `products_price_id` int(11) NOT NULL AUTO_INCREMENT,
  `products_id` int(11) NOT NULL,
  `color` varchar(100) DEFAULT NULL,
  `size` varchar(100) DEFAULT NULL,
  `cost_price` double(11,2) DEFAULT NULL,
  `sale_price` double(11,2) NOT NULL,
  `max_bid` double(11,2) DEFAULT NULL,
  `min_bid` double(11,2) DEFAULT NULL,
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `modified_on` datetime DEFAULT NULL,
  ...
  `attributes` varchar(70) DEFAULT NULL,
  PRIMARY KEY (`products_price_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6811 DEFAULT CHARSET=latin1;

/*Data for the table `products_price` */

insert  into `products_price`(`products_price_id`,`products_id`,`color`,`size`,`cost_price`,`sale_price`,`max_bid`,`min_bid`,`created_on`,`modified_on`,`stock`,`stock_check`,`active`,`barcode`,`attributes`) values (6809,1522,NULL,'Small',0.00,25.00,NULL,0.00,'2021-05-10 14:29:01',NULL,500,1,1,NULL,NULL),(6810,1522,NULL,'Medium',0.00,25.00,NULL,0.00,'2021-05-10 14:29:01',NULL,0,1,1,NULL,NULL);
...
CREATE TABLE `products_sale` (
  ...
  `new_price` double(11,2) NOT NULL,
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`products_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `products_sale` */

/*Table structure for table `products_to_options` */

DROP TABLE IF EXISTS `products_to_options`;

CREATE TABLE `products_to_options` (
  `card_options_id` int(11) NOT NULL,
  `products_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `products_to_options` */
...
CREATE TABLE `promotion_items` (
  `promotion_items_id` int(11) NOT NULL AUTO_INCREMENT,
  `item_no` int(11) NOT NULL COMMENT 'Main item no from inventory',
  `sub_items` int(11) NOT NULL COMMENT 'sub items',
  `products_name` varchar(100) DEFAULT NULL,
  `qty` int(6) NOT NULL DEFAULT 1,
  `sub_item_size` varchar(50) DEFAULT NULL,
  `products_price_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`promotion_items_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

/*Data for the table `promotion_items` */
...
CREATE TABLE `purchase_invoice_detail` (
  `purchase_invoice_detail_id` int(11) NOT NULL AUTO_INCREMENT,
  `purchase_invoice_id` int(11) NOT NULL,
  `item` decimal(20,0) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  ...
  `last_sold` timestamp NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `sale_invoice` (
  ...
  `quote_card_info_id` int(11) DEFAULT NULL,
  `date` date NOT NULL,
  ...
  `created_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `is_reverse` tinyint(1) DEFAULT 0,
  `reciept_type` varchar(100) DEFAULT 'sale',
  `tender` varchar(100) DEFAULT NULL,
  `tender_amount` decimal(10,2) DEFAULT NULL COMMENT 'Collect amount from customer',
  `due_amount` decimal(10,2) DEFAULT 0.00 COMMENT 'change amount after colecting from customer',
  ...
  `final_design` varchar(100) DEFAULT NULL COMMENT 'JPG PNG Images',
  PRIMARY KEY (`sale_invoice_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5202 DEFAULT CHARSET=latin1;
...
CREATE TABLE `sale_invoice_detail` (
  `sale_invoice_detail_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `unit_cost` decimal(10,2) DEFAULT NULL,
  `total` decimal(10,2) DEFAULT NULL,
  `last_sold` timestamp NULL DEFAULT current_timestamp(),
  `total_cost` decimal(10,2) DEFAULT 0.00,
  PRIMARY KEY (`sale_invoice_detail_id`)
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=latin1;

/*Data for the table `sale_invoice_detail` */
...
CREATE TABLE `sale_invoice_payment` (
  `sale_invoice_payment_id` int(11) NOT NULL AUTO_INCREMENT,
  `sale_invoice_id` int(11) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
  `email` varchar(150) DEFAULT NULL,
  `card_number` varchar(100) DEFAULT NULL,
  `brand` varchar(50) DEFAULT NULL,
  `card_exp_month` varchar(100) DEFAULT NULL,
  `card_exp_year` varchar(100) DEFAULT NULL,
...
/*Data for the table `sale_invoice_payment` */

/*Table structure for table `signupcustomers` */

DROP TABLE IF EXISTS `signupcustomers`;

CREATE TABLE `signupcustomers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `createdAt` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `signupcustomers` */
...
/*Data for the table `vendor_offer` */
